	...
	<el-col style="padding-right: 7px;padding-left: 7px">
		<div style="cursor: pointer" @click="toPlayer(video)" :title="video.vname">
			<el-card :body-style="{ padding: '0px' }" class="card">
				<div class="imgs">
					<el-image lazy fit="cover" :src="baseURL + video.coverurl" class="coverImg"/>
					<img src="~assets/img/icon/play-icon.png" class="play-icon el-image" alt=""/>
				</div>
				<div style="padding: 14px;">
					...
					<div class="num">
						{{getVisited(video.visited) + " views"}}
						<!--设置一个插槽，在收藏界面显示移除-->
