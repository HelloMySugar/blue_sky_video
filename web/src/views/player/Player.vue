<template>
	<div class="player">
		...
		<el-breadcrumb class="bread"
			...
			<el-breadcrumb-item>Now Playing：<span class="reslut">{{video.vname}}</span></el-breadcrumb-item>
		</el-breadcrumb>
		<el-row style="padding-top: 12px"  :gutter="20"><!--gutter为栅格的间隔-->
			...
			<el-col :md="24">
				...
				<p-video :video-url="baseURL + video.vurl" :cover-url="baseURL + video.coverurl" v-if="showVideo"
								 v-loading="video.url"
								 element-loading-text="Video Loading"
...
<!--					<el-button v-else class="button-new-tag" size="mini"  @click="showInput">+ 添加标签</el-button>-->
				...
				<span class="description">{{getVisited(video.visited) + " views, release time: " + video.releaseTime}}</span>
